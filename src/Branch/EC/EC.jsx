...
function EC() {
  return (
    <>
      ...
      <Routes>
        <Route path="21EC51M1" element={<Module link="/" />}></Route>
        <Route path="21EC51M2" element={<Module link="/" />}></Route>
        <Route path="21EC51M3" element={<Module link="/" />}></Route>
        <Route path="21EC51M4" element={<Module link="/" />}></Route>
        <Route path="21EC51M5" element={<Module link="/" />}></Route>
        ...
        <Route path="21EC53M1" element={<Module link="/" />}></Route>
        <Route path="21EC53M2" element={<Module link="/" />}></Route>
        <Route path="21EC53M3" element={<Module link="/" />}></Route>
        <Route path="21EC53M4" element={<Module link="/" />}></Route>
        <Route path="21EC53M5" element={<Module link="/" />}></Route>

        <Route path="21EC54M1" element={<Module link="/" />}></Route>
        <Route path="21EC54M2" element={<Module link="/" />}></Route>
        <Route path="21EC54M3" element={<Module link="/" />}></Route>
        <Route path="21EC54M4" element={<Module link="/" />}></Route>
        <Route path="21EC54M5" element={<Module link="/" />}></Route>
      </Routes>
