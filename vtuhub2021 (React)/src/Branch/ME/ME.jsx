...
function ME() {
  return (
    <>
      ...
      <Routes>
        <Route path="21ME51M1" element={<Module link={<iframe src="https://drive.google.com/file/d/1sa1wpYLbB4EgzcZcmIsz05pzkQxk3Ch3/preview" width="640" height="480" allow="autoplay"></iframe>} />}></Route>
        <Route path="21ME51M2" element={<Module link={<iframe src="https://drive.google.com/file/d/1sa1wpYLbB4EgzcZcmIsz05pzkQxk3Ch3/preview" width="640" height="480" allow="autoplay"></iframe>} />}></Route>
        <Route path="21ME51M3" element={<Module link={<iframe src="https://drive.google.com/file/d/1sa1wpYLbB4EgzcZcmIsz05pzkQxk3Ch3/preview" width="640" height="480" allow="autoplay"></iframe>} />}></Route>
        <Route path="21ME51M4" element={<Module link={<iframe src="https://drive.google.com/file/d/1sa1wpYLbB4EgzcZcmIsz05pzkQxk3Ch3/preview" width="640" height="480" allow="autoplay"></iframe>} />}></Route>
        <Route path="21ME51M5" element={<Module link={<iframe src="https://drive.google.com/file/d/1sa1wpYLbB4EgzcZcmIsz05pzkQxk3Ch3/preview" width="640" height="480" allow="autoplay"></iframe>} />}></Route>
        ...
        <Route path="21ME53M1" element={<Module link={<iframe src="https://drive.google.com/file/d/1n7fwDbCJoV33ukNsSgCXGcvfUCgpXvCC/preview" width="640" height="480" allow="autoplay"></iframe>} />}></Route>
        <Route path="21ME53M2" element={<Module link={<iframe src="https://drive.google.com/file/d/1ekGe2Q2rZJj5unrgQ-v4g-fl_aBYqYiw/preview" width="640" height="480" allow="autoplay"></iframe>} />}></Route>
        <Route path="21ME53M3" element={<Module link={<iframe src="https://drive.google.com/file/d/1EZ3dgX8mkpJHMmNpxo01hmyh7KcHL_bF/preview" width="640" height="480" allow="autoplay"></iframe>} />}></Route>
        <Route path="21ME53M4" element={<Module link={<iframe src="https://drive.google.com/file/d/1ubGY3khoM3rVq4vUFFmmcD6e6PAfOCpp/preview" width="640" height="480" allow="autoplay"></iframe>}/>}></Route>
        <Route path="21ME53M5" element={<Module link={<iframe src="https://drive.google.com/file/d/1r7oCBGwH3Fh7y1NWrN0Yrl3znKYjr28X/preview" width="640" height="480" allow="autoplay"></iframe>} />}></Route>
