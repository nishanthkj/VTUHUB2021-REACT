...
function IS() {
  return (
    <>
      ...
      <Routes>
        <Route path="21IS51M1" element={<Module link ={< iframe src="https://drive.google.com/file/d/1f0oLyLRNEaCVr2LvqJ6f3H7EUc6mEBiO/preview" width="640" height="480" allow="autoplay"></iframe>}/>}></Route>
        <Route path="21IS51M2" element={<Module link={< iframe src="https://drive.google.com/file/d/1swzULFwe8-vV8_sAIxryeiCJ20vVbzG6/preview" width="640" height="480" allow="autoplay"></iframe>} />}></Route>
        <Route path="21IS51M3" element={<Module link={< iframe src="https://drive.google.com/file/d/1Fn83pZg4i1FCQPBE1NB2PZyRPV9Gq_HC/preview" width="640" height="480" allow="autoplay"></iframe>} />}></Route>
        <Route path="21IS51M4" element={<Module link={< iframe src="https://drive.google.com/file/d/1PQxxDI-5x3Udtpb2EIEe6u1QrP49dV6t/preview" width="640" height="480" allow="autoplay"></iframe>} />}></Route>
        <Route path="21IS51M5" element={<Module link={< iframe src="https://drive.google.com/file/d/1o3STYfolHeMtK_PecbmmfUmk3ldT41mj/preview" width="640" height="480" allow="autoplay"></iframe>} />}></Route>

        <Route path="21IS52M1" element={<Module link={< iframe src="https://drive.google.com/file/d/1S7fKpj9Oqsurj1hhLLpDw_JeilgUYp7A/preview" width="640" height="480" allow="autoplay"></iframe>} />}></Route>
        <Route path="21IS52M2" element={<Module link={< iframe src="https://drive.google.com/file/d/1to0j8f8lXWraTLCSAFbiHCLB1TT4nzvj/preview" width="640" height="480" allow="autoplay"></iframe>} />}></Route>
        <Route path="21IS52M3" element={<Module link={< iframe src="https://drive.google.com/file/d/1vFqLgN7RGcTNuZigJF24xDB-NbCctWnX/preview" width="640" height="480" allow="autoplay"></iframe>} />}></Route>
        <Route path="21IS52M4" element={<Module link={< iframe src="https://drive.google.com/file/d/1u806_DRQULvci1zWaDhc8Vj7H0T2GG8q/preview" width="640" height="480" allow="autoplay"></iframe> }/>}></Route>
        <Route path="21IS52M5" element={<Module link={< iframe src="https://drive.google.com/file/d/1SsHosIFlARzUto537wgjcKWKRP-KM5hn/preview" width="640" height="480" allow="autoplay"></iframe>}/>}></Route>

        <Route path="21IS53M1" element={<Module link={< iframe src="https://drive.google.com/file/d/1qAQtwfu7tECnfw30AMB7uQ2haBqk7VKR/preview" width="640" height="480" allow="autoplay"></iframe>}/>}></Route>
        <Route path="21IS53M2" element={<Module link={< iframe src="https://drive.google.com/file/d/1A-M6rnuHChjtVjgnIQg8Z6HpTyv94X9w/preview" width="640" height="480" allow="autoplay"></iframe>} />}></Route>
        <Route path="21IS53M3" element={<Module link={< iframe src="https://drive.google.com/file/d/1-hkuoXwqL5_pQI0Pgkw-qWNZngsKQOnw/preview" width="640" height="480" allow="autoplay"></iframe>}/>}></Route>
        <Route path="21IS53M4" element={<Module link={< iframe src="https://drive.google.com/file/d/1cIVwFVd0Jbc3AkJKYrokaTD_wqK5HBCq/preview" width="640" height="480" allow="autoplay"></iframe>} />}></Route>
        <Route path="21IS53M5" element={<Module link={< iframe src="https://drive.google.com/file/d/1uddxk00px7vD2a-k7FmRD9ekuwGRBG_E/preview" width="640" height="480" allow="autoplay"></iframe>}/>}></Route>

        <Route path="21IS54M2" element={<Module link={<iframe src="https://drive.google.com/file/d/1gvy4hpoyG_ns5hdhMEqKGlXrJgIaOOyq/preview" width="640" height="480" allow="autoplay"></iframe>}/>}></Route>
        <Route path="21IS54M3" element={<Module link={<iframe src="https://drive.google.com/file/d/17WHVDVxHhAl2oIY02NEainc3tllwLw50/preview" width="640" height="480" allow="autoplay"></iframe>} />}></Route>
        <Route path="21IS54M4" element={<Module link={<iframe src="https://drive.google.com/file/d/1lbOB4WYw63YBH06rPiZg1Mv3jly6mqDE/preview" width="640" height="480" allow="autoplay"></iframe>} />}></Route>
        <Route path="21IS54M5" element={<Module link={<iframe src="https://drive.google.com/file/d/14Z2yIjg3WILWz3QqnVLPLXyeWWa6G4e3/preview" width="640" height="480" allow="autoplay"></iframe>} />}></Route>
      </Routes>
