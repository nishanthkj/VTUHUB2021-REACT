...
function CV() {
  return (
    <>
      ...
      <Routes>
        <Route path="21CV51M1" element={<Module link={< iframe src="https://drive.google.com/file/d/1lpwQ8KL0yom4yzZHW7sdsTw3QriBvki0/preview" width="640" height="480" allow="autoplay"></iframe> }/>}></Route>
        <Route path="21CV51M2" element={<Module link={< iframe src="https://drive.google.com/file/d/1Kd_zEYgN7iU2htyRsWcr_nAsvBoIwqkv/preview" width="640" height="480" allow="autoplay"></iframe>}/>}></Route>
        <Route path="21CV51M3" element={<Module link={< iframe src="https://drive.google.com/file/d/15zJwGm0udGFmiAiQ0OAtxLhNt824gmB8/preview" width="640" height="480" allow="autoplay"></iframe>}/>}></Route>
        <Route path="21CV51M4" element={<Module link={< iframe src="https://drive.google.com/file/d/1OvEh04Ybdwuv0SREfgeUbA2OZIUtg2Nn/preview" width="640" height="480" allow="autoplay"></iframe> }/>}></Route>
        <Route path="21CV51M5" element={<Module link={< iframe src="https://drive.google.com/file/d/16OufAz3enUJN3cew2SQ2AYTABW6mVbKg/preview" width="640" height="480" allow="autoplay"></iframe> }/>}></Route>

        <Route path="21CV52M1" element={<Module link={< iframe src="https://drive.google.com/file/d/1MOrfjkmNbnjGGro6W55HBqKtTHPm3OqH/preview" width="640" height="480" allow="autoplay"></iframe> }/>}></Route>
        <Route path="21CV52M2" element={<Module link={< iframe src="https://drive.google.com/file/d/19XgBnd3sOHNTePHhY7ecO_j0kqW1cLc7/preview" width="640" height="480" allow="autoplay"></iframe> }/>}></Route>
        <Route path="21CV52M3" element={<Module link={< iframe src="https://drive.google.com/file/d/1ptIkXaVJDR6_UG5gU54xtzKMHlzYElUC/preview" width="640" height="480" allow="autoplay"></iframe>}/>}></Route>
        <Route path="21CV52M4" element={<Module link={< iframe src="https://drive.google.com/file/d/1biIL0-V7VPWQswELFX3gHMmmxzLbI5Sj/preview" width="640" height="480" allow="autoplay"></iframe>} />}></Route>
        <Route path="21CV52M5" element={<Module link={< iframe src="https://drive.google.com/file/d/1Rsxd8VpTxlvL39-a4LDveBYZxAhyzoNn/preview" width="640" height="480" allow="autoplay"></iframe>} />}></Route>

        <Route path="21CV53M1" element={<Module link={< iframe src="https://drive.google.com/file/d/1-MxMRXbEMIVKS2zJb6XWKe5-NMKiONVk/preview" width="640" height="480" allow="autoplay"></iframe>} />}></Route>
        <Route path="21CV53M2" element={<Module link={< iframe src="https://drive.google.com/file/d/1rkUCgHAUtHlJYhP5f6v4O2_QRZ88lVOh/preview" width="640" height="480" allow="autoplay"></iframe> }/>}></Route>
        <Route path="21CV53M3" element={<Module link={< iframe src="https://drive.google.com/file/d/1oco2o2vSJHpaV9ZNlQZMVA8TOJA9_NrY/preview" width="640" height="480" allow="autoplay"></iframe> }/>}></Route>
        <Route path="21CV53M4" element={<Module link={< iframe src="https://drive.google.com/file/d/1SPVqIomy7A3vMCeiipYlXNssHdS2Bwnf/preview" width="640" height="480" allow="autoplay"></iframe> }/>}></Route>
        <Route path="21CV53M5" element={<Module link={< iframe src="https://drive.google.com/file/d/11i1SHpJQfCoPskp0iKqFvZ-Z7J55qK0V/preview" width="640" height="480" allow="autoplay"></iframe>}/>}></Route>

        <Route path="21CV54M1" element={<Module link={< iframe src="https://drive.google.com/file/d/15opdrvwasPC4y4vd3fgd7EO0Fn998j2t/preview" width="640" height="480" allow="autoplay"></iframe> }/>}></Route>
        <Route path="21CV54M2" element={<Module link={< iframe src="https://drive.google.com/file/d/1I7-1WKaHyLw0wrC0gqR0lDTQnTZKWRyn/preview" width="640" height="480" allow="autoplay"></iframe>}/>}></Route>
        <Route path="21CV54M3" element={<Module link={< iframe src="https://drive.google.com/file/d/1KDtVhrISgYWRWksDsQ6-QpyDUBLCsqKQ/preview" width="640" height="480" allow="autoplay"></iframe>} />}></Route>
        <Route path="21CV54M4" element={<Module link={< iframe src="https://drive.google.com/file/d/1sNTPx9EyeUi81yntQxowvzOF2qRbJxOA/preview" width="640" height="480" allow="autoplay"></iframe>}/>}></Route>
        <Route path="21CV54M5" element={<Module link={< iframe src="https://drive.google.com/file/d/1dt0CiWNfOqOvdAJH2bFHGPW5Bp2-CasM/preview" width="640" height="480" allow="autoplay"></iframe>} />}></Route>
      </Routes>
